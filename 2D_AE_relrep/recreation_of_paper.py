...
latent_dim = 3         # If load_saved: Must match an existing dim
anchor_num = 3
...
relative_coords_list = compute_relative_coordinates_cossim(embeddings_list, anchors_list, flatten=False)
